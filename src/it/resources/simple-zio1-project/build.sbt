...
lazy val services = project.in(file("modules/services"))
	...
	.settings(libraryDependencies ++=
		Seq(
			...
			"dev.zio" % "zio-test_2.13" % "1.0.13" % "test",
			"dev.zio" % "zio-test-sbt_2.13" % "1.0.13" % "test",
			"dev.zio" % "zio-test-junit_2.13" % "1.0.13" % "test",
			"dev.zio" % "zio-test-magnolia_2.13" % "1.0.13" % "test"
		)
	)
